...
<footer class="fixed bottom-8 right-8 z-50 hidden md:block">
	<div class="flex flex-col items-center justify-center gap-2 rounded-lg border bg-white/80 px-6 py-4 shadow-sm backdrop-blur-sm">
		<p class="text-sm font-light tracking-wide text-gray-500">
			ThisUX, a forward-thinking product studio
		</p>
		<a 
			href="https://thisux.com" 
			class="group flex items-center gap-2 text-sm font-medium text-gray-900 transition-colors hover:text-primary"
			target="_blank"
			rel="noopener noreferrer"
		>
			thisux.com
